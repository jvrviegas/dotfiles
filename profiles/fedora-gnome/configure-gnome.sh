...
# Fedora GNOME settings applied by the fedora-gnome profile adapter.

GNOME_CONFIG_DIR="$DOTFILES_ROOT/profiles/fedora-gnome/home/.config/gnome"
...
# Keep the helper executable in the deployed tree, including when this script
# is run directly after a repository update.
