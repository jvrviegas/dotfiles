...
Item {
  ...
  component BarPanel: PanelWindow {
    ...
    readonly property int floatingMargin: Style.space(8)
    readonly property int barRadius: Math.min(Style.cornerRadius, root.barSize / 2)
    readonly property int panelThickness: root.barSize + barWindow.floatingMargin

    margins {
      top: root.barHidden && root.position === "top" ? -barWindow.panelThickness : 0
      bottom: root.barHidden && root.position === "bottom" ? -barWindow.panelThickness : 0
      left: root.barHidden && root.position === "left" ? -barWindow.panelThickness : 0
      right: root.barHidden && root.position === "right" ? -barWindow.panelThickness : 0
    }
    ...
    implicitWidth: root.vertical ? barWindow.panelThickness : 0
    implicitHeight: root.vertical ? 0 : barWindow.panelThickness
    color: "transparent"
    ...
    Rectangle {
      anchors {
        fill: parent
        topMargin: root.vertical || root.position === "top" ? barWindow.floatingMargin : 0
        bottomMargin: root.vertical || root.position === "bottom" ? barWindow.floatingMargin : 0
        leftMargin: !root.vertical || root.position === "left" ? barWindow.floatingMargin : 0
        rightMargin: !root.vertical || root.position === "right" ? barWindow.floatingMargin : 0
      }
      color: root.transparent ? "transparent" : root.background
      radius: barWindow.barRadius
      clip: true
